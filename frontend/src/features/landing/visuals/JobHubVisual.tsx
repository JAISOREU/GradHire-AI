    ...
    <div ref={ref} className={`feature-visual feature-visual--jobs ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 420 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="job-search">
          <rect x="50" y="30" width="320" height="32" rx="8" fill="url(#job-search)" stroke="var(--color-border-strong)" strokeWidth="1" />
        ...
        <g className="job-filter">
          <rect x="50" y="74" width="56" height="24" rx="6" fill="var(--color-primary-soft)" stroke="var(--color-primary)" strokeWidth="1" />
        ...
        <g className="job-card-1">
          <rect x="50" y="114" width="320" height="40" rx="10" fill="var(--color-surface-muted)" stroke="var(--color-border-strong)" strokeWidth="1" />
          ...
          <text x="94" y="144" fill="var(--color-text-muted)" fontSize="8">Google · Remote</text>
        ...
        <g className="job-card-2">
          <rect x="50" y="164" width="320" height="40" rx="10" fill="var(--color-primary-soft)" stroke="var(--color-primary)" strokeWidth="1.5" />
          ...
          <text x="94" y="194" fill="var(--color-text-muted)" fontSize="8">Meta · Hybrid</text>
        ...
        <g className="job-card-3">
          ...
          <text x="94" y="240" fill="var(--color-text-muted)" fontSize="8">Stripe · On-site</text>
        </g>
      </svg>
