    ...
    <div ref={ref} className={`feature-visual feature-visual--notifications ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 400 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="notif-panel">
          <rect x="40" y="30" width="320" height="220" rx="14" fill="url(#panel-grad)" stroke="var(--color-border-strong)" strokeWidth="1" />
          ...
          <text x="60" y="58" textAnchor="start" fill="var(--color-text)" fontSize="12" fontWeight="700">Notifications</text>
          <circle cx="340" cy="50" r="5" fill="var(--color-success)" />
          <circle cx="340" cy="50" r="9" fill="url(#live-glow)" opacity="0.6" />
        ...
        <g className="notif-row notif-row--1">
          <rect x="55" y="86" width="290" height="40" rx="8" fill="var(--color-surface)" stroke="var(--color-border)" strokeWidth="1" />
          <circle cx="74" cy="106" r="4" fill="var(--color-primary)" />
          <text x="88" y="103" textAnchor="start" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">Application viewed</text>
          <text x="88" y="115" textAnchor="start" fill="var(--color-text-muted)" fontSize="9">Software Engineer · 2m ago</text>
        </g>

        <g className="notif-row notif-row--2">
          <rect x="55" y="138" width="290" height="40" rx="8" fill="var(--color-primary-soft)" stroke="var(--color-primary)" strokeWidth="1" />
          <circle cx="74" cy="158" r="4" fill="var(--color-primary)" />
          <text x="88" y="155" textAnchor="start" fill="var(--color-primary)" fontSize="10" fontWeight="700">New opportunity matched</text>
          <text x="88" y="167" textAnchor="start" fill="var(--color-text-muted)" fontSize="9">92% profile match · Now</text>
        </g>

        <g className="notif-row notif-row--3">
          <rect x="55" y="190" width="290" height="40" rx="8" fill="var(--color-surface)" stroke="var(--color-border)" strokeWidth="1" />
          <circle cx="74" cy="210" r="4" fill="var(--color-info)" />
          <text x="88" y="207" textAnchor="start" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">Interview invitation</text>
          <text x="88" y="219" textAnchor="start" fill="var(--color-text-muted)" fontSize="9">Tomorrow · 10:00 AM</text>
        </g>
      </svg>
