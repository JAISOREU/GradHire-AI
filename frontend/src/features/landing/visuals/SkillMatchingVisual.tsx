    ...
    <div ref={ref} className={`feature-visual feature-visual--skills ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 400 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="skill-group skill-group--candidate">
          ...
          <text x="100" y="56" textAnchor="middle" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">Your skills</text>
        ...
        <g className="skill-group skill-group--job">
          ...
          <text x="300" y="56" textAnchor="middle" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">Role requirements</text>
        ...
        <g className="match-badge">
          <circle cx="200" cy="140" r="28" fill="var(--color-surface)" stroke="var(--color-border-strong)" strokeWidth="1" />
          <circle cx="200" cy="140" r="22" fill="none" stroke="url(#match-ring)" strokeWidth="3" strokeDasharray="138" strokeDashoffset="18" strokeLinecap="round" transform="rotate(-90 200 140)" />
          <text x="200" y="136" textAnchor="middle" fill="var(--color-primary)" fontSize="12" fontWeight="700">87%</text>
          <text x="200" y="150" textAnchor="middle" fill="var(--color-text-muted)" fontSize="8" fontWeight="600">Profile Match</text>
        </g>
      </svg>
