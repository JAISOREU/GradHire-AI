    ...
    <div ref={ref} className={`feature-visual feature-visual--skills ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 420 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="skill-group skill-group--candidate">
          <rect x="40" y="40" width="150" height="24" rx="6" fill="var(--color-surface-muted)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <text x="115" y="56" textAnchor="middle" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">Your skills</text>

          <rect x="50" y="80" width="100" height="26" rx="6" fill="url(#skill-chip-candidate)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <text x="100" y="97" textAnchor="middle" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">React</text>

          <rect x="50" y="116" width="100" height="26" rx="6" fill="url(#skill-chip-candidate)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <text x="100" y="133" textAnchor="middle" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">Python</text>

          <rect x="50" y="152" width="100" height="26" rx="6" fill="url(#skill-chip-candidate)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <text x="100" y="169" textAnchor="middle" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">SQL</text>

          <rect x="50" y="188" width="100" height="26" rx="6" fill="url(#skill-chip-candidate)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
        ...
        <g className="skill-group skill-group--job">
          <rect x="230" y="40" width="150" height="24" rx="6" fill="var(--color-surface-muted)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          ...
          <rect x="250" y="152" width="100" height="26" rx="6" fill="url(#skill-chip-job)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <text x="300" y="169" textAnchor="middle" fill="var(--color-text-secondary)" fontSize="10" fontWeight="600">REST APIs</text>

          <rect x="250" y="188" width="100" height="26" rx="6" fill="url(#skill-chip-job)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
        ...
        <g className="skill-conns">
          ...
          <line x1="150" y1="165" x2="250" y2="165" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" strokeDasharray="3 3" opacity="0.4" />
          <line x1="150" y1="201" x2="250" y2="201" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" strokeDasharray="3 3" opacity="0.4" />
        </g>

        <g className="match-badge">
          <circle cx="210" cy="140" r="28" fill="var(--color-surface)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
