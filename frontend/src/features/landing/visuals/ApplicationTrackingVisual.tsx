    ...
    <div ref={ref} className={`feature-visual feature-visual--tracking ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 420 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="track-header">
          <rect x="19" y="26" width="412" height="32" rx="8" fill="var(--color-surface-muted, #fefcf8)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
        ...
        <g className="track-step track-step--0">
          <rect x="19" y="70" width="412" height="32" rx="8" fill="var(--color-surface, #ffffff)" stroke="var(--color-primary, #4f46e5)" strokeWidth="1.5" />
          <circle cx="41" cy="86" r="10" fill="var(--color-primary-soft, #eef2ff)" stroke="var(--color-primary, #4f46e5)" strokeWidth="1.5" />
          <text x="65" y="84" fill="var(--color-primary, #4f46e5)" fontSize="11" fontWeight="700">Applied</text>
          <text x="65" y="96" fill="var(--color-text-muted, #8c8680)" fontSize="9">Today</text>
          <rect x="380" y="79" width="37" height="16" rx="4" fill="var(--color-primary, #4f46e5)" />
          <text x="399" y="91" textAnchor="middle" fill="var(--color-primary-text, #ffffff)" fontSize="9" fontWeight="700">Sent</text>
        </g>

        <g className="track-step track-step--1">
          <rect x="19" y="112" width="412" height="32" rx="8" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #e8e2d8)" strokeWidth="1" />
          <circle cx="41" cy="128" r="10" fill="var(--color-surface, #ffffff)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1.5" />
          <text x="65" y="126" fill="var(--color-text-secondary, #5c5852)" fontSize="11" fontWeight="600">Viewed</text>
          <text x="65" y="138" fill="var(--color-text-muted, #8c8680)" fontSize="9">Yesterday</text>
        </g>

        <g className="track-step track-step--2">
          <rect x="19" y="154" width="412" height="32" rx="8" fill="var(--color-surface, #ffffff)" stroke="var(--color-border, #e8e2d8)" strokeWidth="1" />
          <circle cx="41" cy="170" r="10" fill="var(--color-surface, #ffffff)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1.5" />
          <text x="65" y="168" fill="var(--color-text-secondary, #5c5852)" fontSize="11" fontWeight="600">Review</text>
          <text x="65" y="180" fill="var(--color-text-muted, #8c8680)" fontSize="9">Pending</text>
        </g>

        <g className="track-step track-step--3">
          <rect x="19" y="196" width="412" height="32" rx="8" fill="var(--color-surface-muted, #fefcf8)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <circle cx="41" cy="212" r="10" fill="var(--color-surface, #ffffff)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1.5" />
          <text x="65" y="210" fill="var(--color-text-secondary, #5c5852)" fontSize="11" fontWeight="600">Interview</text>
          <text x="65" y="222" fill="var(--color-text-muted, #8c8680)" fontSize="9">Upcoming</text>
        </g>
      </svg>
