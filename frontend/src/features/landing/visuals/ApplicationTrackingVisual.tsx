    ...
    <div ref={ref} className={`feature-visual feature-visual--tracking ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 400 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="track-header">
          <rect x="40" y="30" width="320" height="32" rx="8" fill="var(--color-surface-muted)" stroke="var(--color-border-strong)" strokeWidth="1" />
          <text x="60" y="50" textAnchor="start" fill="var(--color-text)" fontSize="11" fontWeight="700">Application Tracking</text>
