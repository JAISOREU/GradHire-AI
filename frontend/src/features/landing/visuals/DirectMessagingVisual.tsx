    ...
    <div ref={ref} className={`feature-visual feature-visual--messaging ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 420 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="chat-window">
          <rect x="50" y="30" width="320" height="220" rx="14" fill="url(#chat-bg)" stroke="var(--color-border-strong)" strokeWidth="1" />
          ...
          <text x="70" y="58" textAnchor="start" fill="var(--color-text)" fontSize="12" fontWeight="700">Hiring Team</text>
        ...
        <g className="msg-status">
          <rect x="70" y="222" width="140" height="12" rx="6" fill="var(--color-success-soft)" />
          <text x="140" y="232" textAnchor="middle" fill="var(--color-success)" fontSize="9" fontWeight="700">Conversation continued</text>
        </g>
      </svg>
