    ...
    <div ref={ref} className={`feature-visual feature-visual--messaging ${inView ? 'is-animated' : ''}`} aria-hidden="true">
      <svg viewBox="0 0 420 280" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        ...
        <g className="chat-window">
          <rect x="30" y="30" width="320" height="220" rx="14" fill="url(#chat-bg)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <rect x="30" y="30" width="320" height="40" rx="14" fill="var(--color-surface-muted, #fefcf8)" stroke="var(--color-border-strong, #d5cfc6)" strokeWidth="1" />
          <rect x="30" y="56" width="320" height="14" fill="var(--color-surface-muted, #fefcf8)" stroke="none" />
          <text x="50" y="58" textAnchor="start" fill="var(--color-text, #1a1814)" fontSize="12" fontWeight="700">Hiring Team</text>
        ...
        <g className="msg-candidate">
          <rect x="120" y="86" width="210" height="40" rx="10" fill="url(#msg-candidate)" />
          <text x="320" y="110" textAnchor="end" fill="var(--color-primary-text, #ffffff)" fontSize="10" fontWeight="600">Interested in this role.</text>
        </g>

        <g className="msg-typing">
          <circle cx="330" cy="144" r="3" fill="var(--color-text-muted, #8c8680)" opacity="0.6" />
          <circle cx="340" cy="144" r="3" fill="var(--color-text-muted, #8c8680)" opacity="0.6" />
          <circle cx="350" cy="144" r="3" fill="var(--color-text-muted, #8c8680)" opacity="0.6" />
        </g>
